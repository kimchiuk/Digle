        ...
        <div className="flex flex-wrap justify-center max-w-screen-md mx-auto">
          <div className="flex-1 mr-10">
            ...
            <div className="flex justify-center pt-12">
              <button type="button" className="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-xl text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700 font-extrabold  ">
                확인했습니다!
              </button>
            </div>
          </div>
