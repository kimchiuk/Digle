    ...
    <div className="center">
      <div className="w-96 mx-auto pt-20 text-left">
        ...
        <div className="m-2 p-2 h-60 border-2 overflow-y-auto">
          1. 서론
          <br /><br />
          본 이용약관은 [웹사이트 이름]에서 제공하는 모든 서비스(이하 '서비스')의 이용 조건 및 절차, 이용자와 [웹사이트 이름]의 권리, 의무, 책임사항 등 기본적인 사항을 규정함을 목적으로 합니다.
          <br /><br />
          2. 서비스 이용 계약의 성립
          <br /><br />
          서비스 이용 계약은 이용자가 본 약관의 내용에 동의하고, 회원가입 양식에 따라 회원정보를 기입하여 회원가입을 신청한 후 [웹사이트 이름]이 이를 승낙함으로써 체결됩니다.
          이용자가 온라인 가입신청 양식에 기재하는 모든 정보는 실제 데이터인 것으로 간주합니다.
          <br /><br />
          3. 서비스 제공 및 변경
          <br /><br />
          [웹사이트 이름]은 지속적이고 안정적인 서비스 제공을 위해 노력합니다.
          서비스의 내용이 변경되거나 종료될 경우 [웹사이트 이름]은 이용자에게 알려야 할 의무가 있으며, 이는 공지사항 등을 통해 이루어집니다.
          <br /><br />
          4. 이용자의 의무
          <br /><br />
          이용자는 개인정보 보호를 위해 자신의 계정 정보를 적절히 관리해야 합니다.
          이용자는 [웹사이트 이름]의 서비스를 법적인 목적으로만 사용해야 합니다.
          <br /><br />
          5. 계약 해지 및 이용 제한
          <br /><br />
          이용자가 서비스 이용 계약을 해지하고자 할 때는 언제든지 회원탈퇴를 요청할 수 있습니다.
          [웹사이트 이름]은 이용자가 본 약관에서 규정하는 사항을 위반하는 경우 서비스 이용을 제한할 수 있습니다.
          <br />
        </div>
        ...
        <div className="m-2 p-2 h-60 border-2 overflow-y-auto">
          1. 개인정보의 수집
          <br /><br />
          [웹사이트 이름]은 회원가입, 서비스 신청 등을 위해 이용자의 개인정보를 수집할 수 있습니다.
          ...
          3. 개인정보의 보유 및 이용 기간
          <br /><br />
          [웹사이트 이름]은 이용자의 개인정보를 서비스 제공 기간 동안에만 보유하며, 이용 목적이 달성된 후에는 해당 정보를 즉시 파기합니다.
          <br /><br />
          4. 개인정보의 제3자 제공
          <br /><br />
          [웹사이트 이름]은 법적인 요구가 있는 경우를 제외하고는 어떠한 경우에도 이용자의 개인정보를 제3자에게 제공하지 않습니다.
          <br />
        </div>
        <div className="p-2 flex items-center justify-end">
