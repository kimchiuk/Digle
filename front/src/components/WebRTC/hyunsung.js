...
function Anhs() {
  ...
  return (
    <div className="flex flex-col items-center justify-start min-h-screen bg-gray-200 pt-16">
      <div className="w-full h-1/2 px-3 py-4 bg-white rounded-xl shadow-md">
